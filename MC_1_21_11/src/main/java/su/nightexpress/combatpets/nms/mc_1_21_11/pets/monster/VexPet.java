...
public class VexPet extends Vex implements PetEntity {
    ...
    private static final Class<?> CLASS_VEX_A;

    private static final Constructor<?> CONSTR_VEX_A;

    static {
        CLASS_VEX_A = Reflex.safeInnerClass(Vex.class.getName(), "VexChargeAttackGoal"); // a
