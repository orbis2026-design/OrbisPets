...
//        DamageSource fixed = new DamageSource(damageSource.typeHolder(), damageSource.getDirectEntity(), null, damageSource.sourcePositionRaw());
//
//        return super.hurtServer(level, fixed, damage);
        //return PetBrain.hurt(this, level, fixed, damage);

//        boolean flag = PetBrain.hurt(this, level, damageSource, damage);
